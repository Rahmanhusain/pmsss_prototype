            ...
            <div className="flex h-[calc(100vh-5rem)] w-screen">
                ...
                <div className="bg-[#036d6c] m-5 p-5 w-1/5   rounded-xl relative">
                    ...
                    <ul className="text-white text-xl font-medium">
                        <Link href={"#"} className="flex justify-center text-base my-5 p-2 border-b-2 border-slate-200 cursor-pointer no-underline font-normal">Your Profile (SAG Admin)</Link>
                        <Link href={"#"} className="flex justify-center text-base my-5 p-2 border-b-2 border-slate-200 cursor-pointer no-underline font-normal">Announcement</Link>
                        <Link href={"#"} className="flex justify-center text-base my-5 p-2 border-b-2 border-slate-200 cursor-pointer no-underline font-normal">Notices</Link>
                    </ul>
                ...
                <div className="m-5 p-5 w-4/5">
                    ...
                    <div className="grid grid-cols-4 gap-6 w-full my-5">
                        <div className="bg-[#B7F176] cursor-pointer rounded-lg h-48 flex relative flex-col justify-center items-center">
                            ...
                            <p className="text-lg absolute bottom-4">Numbers of applications</p>
                        </div>
                        <div className="bg-[#9a1f8e59] cursor-pointer rounded-lg h-48 flex relative flex-col justify-center items-center">
                            <h1 className="text-6xl relative top-[-15px] font-normal">368000</h1>
                            <p className="text-lg absolute bottom-4">Deficient Applications</p>
                        </div>
                        ...
                        <div className="bg-[#2db8b880] cursor-pointer rounded-lg h-48 flex relative flex-col justify-center items-center">
                            ...
                            <p className="text-lg absolute bottom-4">Completed Applications</p>
                        </div>
